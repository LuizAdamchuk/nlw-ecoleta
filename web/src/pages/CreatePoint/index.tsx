...
export const CreatePoint: React.FC = () => {
  ...
  const [selectedItems, setSetelectedItems] = useState<number[]>([]);
...
`,
      ...
      .then(response => {
        const citiesName = response.data.map(
  ...
  const handleSelectItem = useCallback(
    (id: number) => {
      ...
      if (alreadySelected >= 0) {
        ...
        setSetelectedItems(filteredItems);
      } else {
        setSetelectedItems([...selectedItems, id]);
      }
    },
    [selectedItems],
  );
